...
<div class="deal_detail">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{URL::to('/approve/deal')}}/{{$deal->id}}"><button class="btn btn-success">Одобри</button></a>
                <a href="{{URL::to('/delete/deal')}}/{{$deal->id}}"><button class="btn btn-danger">Избриши</button></a>
                <a href="{{URL::to('/update/deal')}}/{{$deal->id}}"><button class="btn btn-info">Измени</button></a>
            </div>
        </div>
